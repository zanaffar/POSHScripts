...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-ProcessAsUser -Path "$env:WinDir\regedit.exe" -Parameters "/S $dirFiles\hkcu speech.reg"
     
        Set-RegistryKey -Key 'HKLM\SOFTWARE\WOW6432Node\Policies\Adobe\Acrobat Reader\2015\FeatureLockDown' -Name 'bProtectedMode' -Value "0" -Type DWord
