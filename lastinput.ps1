...
#>
				...
				Param (
					...
					[string]$LogFileDirectory = 'C:\Logs',
...
#>
            ...
            #    [string]$executeProcessAsUserParametersVBS = 'chr(34) & ' + "`"$($Path)`"" + ' & chr(34) & ' + '" ' + ($Parameters) + '"'
...
'@
            ...
            Write-Output $objResult | Select-Object -Property DomainUser,LastInput,IdleTimeString
		} 
