...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
        ...
        $Script = {
            $Language = New-WinUserLanguageList -Language 'en-US'
            # Add Hebrew
            $Language.Add('he')
		...
		Execute-ProcessAsUser -Path "powershell.exe" -Parameters "-EncodedCommand $EncodedCommand" -Wait -RunLevel LeastPrivilege
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-MSI -Action Uninstall -Path "$dirFiles\" -Parameters ""		
