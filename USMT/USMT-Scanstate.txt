...
if ($Local) {
	...
	if ($PSBoundParameters.ContainsKey('Force')) {
		USMT-Scanstate -Users $Users -Force
	} else {
		USMT-Scanstate -Users $Users
	}
}

if ($PSBoundParameters.ContainsKey('ComputerName')) {
	if ($PSBoundParameters.ContainsKey('Force')) {
		USMT-Scanstate -ComputerName $ComputerName -Users $Users -Credential $Credential -Force
	} else {
		USMT-Scanstate -ComputerName $ComputerName -Users $Users -Credential $Credential
	}
}