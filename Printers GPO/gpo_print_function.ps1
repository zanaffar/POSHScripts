[String]$print_server="\\wlb-print-03"
[String]$printer_server_string = "*\\MU2000\*"

Function Get-GPOPrinters($print_server, $printer_string) {
...
foreach($printer_string in $printGPO_xml.gpo.User.ExtensionData.Extension.Printers.SharedPrinter.properties.path) {
    ...
    if($printer_string -notlike "*\\WLB-PRINT-03\*") {
...
#Get-GPOPrinters($print_server, $printer_string)